...
fn yaml_index_str() {
    ...
    assert_eq!(doc["foo"], Yaml::Integer(1));
    assert_eq!(doc["bar"], Yaml::Integer(2));
    assert_eq!(doc["baz"], Yaml::Integer(3));
}
...
fn yaml_index_str_mut() {
    ...
    doc["foo"] = Yaml::Integer(4);
    assert_eq!(doc["foo"], Yaml::Integer(4));
}
...
fn yaml_index_str_oob_mut() {
    let mut doc = get_yaml_mapping();
    doc["oob"] = Yaml::Integer(4);
}

#[test]
fn marked_yaml_index_str() {
    let doc = get_marked_yaml_mapping();
    assert_eq!(doc.data["foo"].data, YamlData::Integer(1));
    assert_eq!(doc.data["bar"].data, YamlData::Integer(2));
    assert_eq!(doc.data["baz"].data, YamlData::Integer(3));
}
...
fn marked_yaml_index_str_mut() {
    ...
    doc.data["foo"] = YamlData::Integer(4).into();
    assert_eq!(doc.data["foo"].data, YamlData::Integer(4));
}
...
fn marked_yaml_index_str_oob_mut() {
    let mut doc = get_marked_yaml_mapping();
    doc.data["oob"].data = YamlData::Integer(4);
}

#[test]
fn yaml_index_integer() {
    let doc = get_yaml_sequence();
    assert_eq!(doc[0], Yaml::String("foo".into()));
    assert_eq!(doc[1], Yaml::String("bar".into()));
    assert_eq!(doc[2], Yaml::String("baz".into()));
}
...
fn yaml_index_integer_mut() {
    ...
    doc[0] = Yaml::Integer(4);
    assert_eq!(doc[0], Yaml::Integer(4));
}
...
fn yaml_index_integer_oob_mut() {
    let mut doc = get_yaml_sequence();
    doc[12] = Yaml::Integer(4);
}

#[test]
fn marked_yaml_index_integer() {
    let doc = get_marked_yaml_sequence();
    assert_eq!(doc.data[0].data, YamlData::String("foo".into()));
    assert_eq!(doc.data[1].data, YamlData::String("bar".into()));
    assert_eq!(doc.data[2].data, YamlData::String("baz".into()));
}
...
fn marked_yaml_index_integer_mut() {
    ...
    doc.data[0] = YamlData::Integer(4).into();
    assert_eq!(doc.data[0].data, YamlData::Integer(4));
}
